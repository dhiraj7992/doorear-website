...
export default function MarketingPageHero({
  ...
  return (
    <section className='doorear-hero-shell aigocy-hero-shell relative overflow-hidden border-b border-[var(--app-border)]/50'>
      ...
      <div className='marketing-container relative z-10 pb-14 pt-8 md:pb-18 md:pt-12 lg:pb-22 lg:pt-14'>
        <motion.div
          ...
          className='doorear-eyebrow-pill aigocy-eyebrow-pill inline-flex w-fit max-w-full items-center gap-2.5 rounded-full px-4 py-2 text-xs font-semibold text-[var(--app-foreground)]'>
          <span className='doorear-pulse-dot aigocy-pulse-dot h-2 w-2 shrink-0 rounded-full bg-[var(--app-primary)]' />
          <Sparkles className='h-3.5 w-3.5 shrink-0 text-[var(--app-accent)]' aria-hidden />
          <span>{eyebrow}</span>
        </motion.div>
        ...
        <div
              ...
              <motion.div
                ...
                {cta ? (
                  <LinkButton
                    ...
                    variant='primary'
                    size='section'
                    className='group shadow-lg shadow-teal-700/25'>
                    {cta.label}
          ...
          {hasVisual ? (
            <motion.div
              ...
              <div className='hero-image-glow absolute -inset-4 rounded-[2.5rem] bg-gradient-to-br from-[var(--app-primary)]/30 via-[var(--app-primary-ink)]/15 to-[var(--app-accent)]/15 blur-3xl md:-inset-6' />
              <div
                className={`doorear-visual-frame aigocy-visual-frame relative overflow-hidden ${isProductUi ? 'rounded-xl' : 'rounded-[1.75rem]'}`}>
                {isProductUi ? (
                  <div
