...
export default function AIDemoSection() {
  ...
  return (
    <section className='py-16 md:py-20' aria-label='AI mini demo'>
      <div className='marketing-container'>
        <div className='mx-auto max-w-3xl text-center'>
          ...
          <h2 className='mt-2 text-3xl font-bold tracking-tight text-[var(--app-foreground)] md:text-4xl'>
            What “AI-assisted operations” looks like in practice
          </h2>
          <p className='mt-4 text-base leading-relaxed text-[var(--app-muted)]'>
            No hype—just a workflow that helps supervisors and dispatchers prioritize the right actions
            faster.
          </p>
        </div>
        ...
        <div className='mt-12 grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-start'>
            ...
            {steps.map((s, i) => {
              ...
              return (
                <motion.button
                  ...
                  className={`w-full rounded-2xl border bg-[var(--app-card)] p-5 text-left shadow-sm transition ${
                    isActive
                      ? 'border-[var(--app-primary)]/30 ring-1 ring-[var(--app-primary)]/15'
                      : 'border-[var(--app-border)] hover:border-[var(--app-primary)]/20'
                  }`}
                >
          ...
          <motion.div
            ...
            className='relative overflow-hidden rounded-2xl border border-[var(--app-border)] bg-gradient-to-b from-[var(--app-card)] to-[var(--app-card)]/70 p-6 shadow-sm'
          >
            <div
            ...
            <div className='mt-5 rounded-2xl border border-[var(--app-border)] bg-white/70 p-5 backdrop-blur-sm'>
              <div className='flex items-start justify-between gap-3'>
                ...
                <span className='inline-flex items-center gap-2 rounded-full border border-[var(--app-border)] bg-white px-3 py-1 text-[10px] font-semibold text-[var(--app-muted)]'>
              ...
              <dl className='mt-5 grid gap-3 sm:grid-cols-2'>
                {activeStep.panel.lines.map((line) => (
                  <div
                    key={line.k}
                    className='rounded-xl border border-[var(--app-border)] bg-white px-4 py-3'
                  >
