    ...
    <section id='features'>
      <div className='container'>
        ...
        <p className='text-black/60 text-lg text-center md:max-w-[60%] mx-auto'>
         Stay in control of your bookings, shipments, 
         and delivery operations- all from one place. Doorear helps you manage logistics with speed, 
         visibility, and zero complexity
        </p>
