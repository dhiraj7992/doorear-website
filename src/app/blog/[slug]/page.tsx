...
export default async function BlogPostPage({ params }: Props) {
  ...
  return (
    <>
      ...
      <article className='relative border-b border-[var(--app-border)] bg-[var(--app-surface)]'>
        <MotionInView className='marketing-container max-w-3xl py-14 md:py-20'>
          <div className='rounded-2xl border border-[var(--app-border)] bg-[var(--app-card)] p-8 shadow-sm md:p-10'>
            ...
            <div className='mt-12 rounded-2xl border border-[var(--app-border)] bg-gradient-to-br from-[var(--app-surface)] to-[var(--app-card)] p-6'>
